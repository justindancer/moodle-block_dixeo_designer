...
$string['designer_placeholder_course_title'] = 'Kurstitel';
$string['designer_placeholder_course_summary'] = 'Kurszusammenfassung (optional)';
$string['designer_placeholder_section_title'] = 'Abschnittstitel';
$string['designer_placeholder_section_summary'] = 'Abschnittszusammenfassung (optional)';
$string['designer_placeholder_module_title'] = 'Aktivitätstitel';
$string['designer_placeholder_module_summary'] = 'Aktivitätszusammenfassung (optional)';
$string['designer_placeholder_module_instructions'] = 'Fügen Sie Anweisungen für die KI hinzu, die beschreiben, was diese Aktivität enthalten soll';
...
$string['designer_structure_validation_failed_title'] = 'Kurs kann noch nicht erstellt werden';
